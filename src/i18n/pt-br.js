export default {
  ...
  menuItems: {
    ...
    exit: "Saír da Carteira GUI Worktips",
  ...
  notification: {
    ...
    warnings: {
      ...
      usingRemoteNode: "worktipsd não encontrado, utilizando nódulo remoto"
    }
  },
  placeholders: {
  ...
  strings: {
    ...
    worktipsUnlockedBalance: "Saldo desbloqueado",
    worktipsUnlockedShort: "Desbloqueado",
