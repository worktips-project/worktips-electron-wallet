    ...
    <q-modal-layout>
      ...
      <div class="layout-padding">
        ...
        <div class="info row justify-between">
          <div class="infoBox">
            <div class="infoBoxContent">
              ...
              <div class="value">
                <span><FormatWorktips :amount="node.staking_requirement" raw-value/></span>
              </div>
            </div>
          </div>
          <div class="infoBox">
            <div class="infoBoxContent">
              ...
              <div class="value">
                <span><FormatWorktips :amount="node.total_contributed" raw-value/></span>
              </div>
            </div>
          </div>
          <div class="infoBox">
        ...
        <q-list no-border :dark="theme == 'dark'" class="worktips-list">
          ...
          <q-item v-for="contributor in contributors" :key="contributor.address" class="worktips-list-item">
            <q-item-main>
